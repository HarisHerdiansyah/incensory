...
export default function ProductCard({
  ...
  return (
    <div className='w-[230px] h-[350px] p-3.5 border border-slate-200 rounded-lg shadow-sm flex flex-col justify-between'>
        ...
        <div className='embla__viewport relative' ref={emblaRef}>
          <div className='embla__container w-[200px]'>
            {productImages.map((image) => (
              <div className='border h-[200px] rounded-lg embla__slide' key={image.id}>
                <Image
      ...
      <Popover>
        <PopoverTrigger className='py-1.5 bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80 cursor-pointer rounded-md transition-all flex items-center justify-center gap-2'>
